...
## variable setting
parser = argparse.ArgumentParser(description="CycleGAN for style transfer parameters",
...
parser.add_argument("--lambda_identity_mapping", default=0.5, type=float, dest='lambda_identity')
parser.add_argument("--lambda_cycle_consistency")
