...
from english_scraper import ScrapingEssentials
import threading
...
def login(driver, username, password):
    ...
    email.send_keys("jisw0210@naver.com")
    password.send_keys("wltmddn0210")
...
def download_pages(driver, valid_urls):
    ...
    while list_counter < 100 and beginning - end < 30:
        beginning = time.time()
        # ----------------------------------EDIT THE CODE BELOW------------------------------#
